...
class StorageVirtualNetwork:
    def __init__(self):
        ...
        self.simulation_time: float = 0.0 # <--- NEW: Global Simulation Clock
        ...
        for chunk in transfer.chunks:
            if chunk.status != TransferStatus.COMPLETED and chunks_transferred < chunks_per_step:
                ...
                if success:
                    ...
                    time_spent_in_step += transfer_time # Aggregate the time
                else:
    ...
    def get_network_stats(self) -> Dict[str, Union[int, float]]:
        ...
        return {
            ...
            "simulation_time_seconds": self.simulation_time # Report time
        }